...
ZEND_BEGIN_ARG_INFO_EX(arginfo_pdoracle_enginesql_executequery, 0, 0, 1)
	ZEND_ARG_INFO(0, query)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_pdoracle_enginesql_preparestatement, 0, 0, 2)
	ZEND_ARG_INFO(0, query)
...
ZEPHIR_INIT_FUNCS(pdoracle_enginesql_method_entry) {
	...
	PHP_ME(Pdoracle_EngineSQL, executeQuery, arginfo_pdoracle_enginesql_executequery, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Pdoracle_EngineSQL, executeUpdate, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Pdoracle_EngineSQL, prepareStatement, arginfo_pdoracle_enginesql_preparestatement, ZEND_ACC_PUBLIC)
	PHP_ME(Pdoracle_EngineSQL, _prepareInterrogation, arginfo_pdoracle_enginesql__prepareinterrogation, ZEND_ACC_PRIVATE)
